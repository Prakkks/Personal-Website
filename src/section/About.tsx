...
const About = () => {
  ...
  return (
    <section className=" c-space my-10 sm:my-20 rounded-xl border " id="about" >
      ...
      {/* Image */}
        ...
        alt="Profile"
        className="rounded-xl w-60 sm:w-75 h-auto shadow-lg "
      />

      {/* Text Content */}
      <div className="  md:text-left">
        {/* Bold intro */}
        <h1 className="text-3xl md:text-4xl font-semibold mb-4 sm:mb-6 text-gray-300  text-center sm:text-left \">
          About Me
        </h1>
        ...
        <p className="text-gray-500 text-[14px] sm:text-base leading-relaxed mb-4 text-justify ">
        ...
        <p className="text-gray-500 text-[14px] sm:text-base leading-relaxed text-justify mb-4">
       ...
       I served as a general member of the Rotaract Club of Bagmati for 3 years and was also part of my college’s Electronics Club. I enjoy learning new tools, collaborating on exciting ideas, and staying active through dancing and indoor gardening.
        ...
        <div className="flex flex-row gap-5 justify-start items-start"> 
          <div onClick={handleCopy} className=" flex flex-row gap-2 items-center cursor-pointer p-2 sm:p-3 rounded-md bg-[#321A7D]  border-2 border-[#915eff]/5 transition-all active:scale-95 text-white "> <img src={hasCopied ? 'assets/tick.svg' : 'assets/copy.svg'} className="w-5 h-5" alt="copy" /><span> Copy Email </span></div>
          <div className=" cursor-pointer p-3 rounded-md bg-[#321A7D]  border-2 border-[#915eff]/5 transition-all active:scale-95 text-white " ><a href="#project">My Projects</a></div>
